...
-- keymap('n', '<Leader>dq', function() require('dap').terminate() end, opts)
...
-- Steps:
-- keymap('n', '<Leader>dsf', function() require('dap').step_over() end, opts)
-- keymap('n', '<Leader>dsb', function() require('dap').step_back() end, opts)
